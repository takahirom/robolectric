 ...
 *
 * Run ./gradlew integration_tests:roborazzi:recordRoborazziDebug to record the reference
 * screenshots(golden images). Run ./gradlew integration_tests:roborazzi:verifyRoborazziDebug to
